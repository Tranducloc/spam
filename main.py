...
viptime = 100
ALLOWED_GROUP_ID = -1002160253825   # ID BOX
admin_diggory = "cskh_faifai" # ví dụ : để user name admin là @diggory347 bỏ dấu @ đi là đc
name_bot = "Zancac"
zalo = "no"
web = "no"
facebook = "no"
...
tool = 'no'
BOT_LINK = 'comesoon'
TOKEN = '8174701866:AAHzVtQwTbfajjz4K5h0rPzod5sM_jKiMZk'  
bot = TeleBot(TOKEN)
